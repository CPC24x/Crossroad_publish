...
public class OE_SubjectSchemeIdentifier_Enum : OE_Enum
{
    public OE_SubjectSchemeIdentifier_Enum() : base(new Dictionary<string, string>
    {
        ...
        {"26","Warengruppen"},
        {"27","SWD (Schlagwortnormdatei – Subject Headings Authority File in the German"},
        {"28","Thèmes Electre"},
        ...
        {"71","YSO"},
        {"72","PTO"},
        {"73","Suomalainen kirja"},
        {"74","Sears"},
        {"75","BIC E4L"},
        {"76","CSR"},
        {"77","Suomalainen oppiaineluokitus"},
        {"78","Japanese book trade C"},
        ...
        {"C0","Læreplaner"},
        {"C1","Kompetansemål"},
        {"C2","Kompetansemålsett"},
        {"C3","Tverrfaglige temaer"},
